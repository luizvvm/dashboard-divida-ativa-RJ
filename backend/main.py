...
def get_resumo(file_name: str):
    ...
    try:
        ...
        raise HTTPException(status_code=404, detail=f"Arquivo '{file_name}.json' não encontrado.")
...
def search_cdas(
    ...
    if natureza:
        ...
        df_filtered = df_filtered[df_filtered['natureza'].str.lower() == natureza.lower()]
    if score_min:
